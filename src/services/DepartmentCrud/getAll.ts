...
import type { GetAllDepartmentsParams, DepartmentItem } from "./types";

export async function getAllDepartments(
    params?: GetAllDepartmentsParams
): Promise<{ items: DepartmentItem[]; totalCount: number }> {
    ...
    const url = query
        ? `/services/app/DepartmentCrud/GetAll?${query}`
        : "/services/app/DepartmentCrud/GetAll";
