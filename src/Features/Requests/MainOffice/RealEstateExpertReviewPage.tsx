...
export function DepartmentRealEstateExpertReviewPage({
  ...
  // فرم ثبت‌شده توسط شعبه / شعبه مستقل / منطقه؛ فقط قابل مشاهده
    ...
    async (req: RequestItem) => {
      ...
      try {
        ...
        try {
          ...
          // فرم سایر واحدها صرفاً قابل مشاهده است.
          const externalForm =
            appraisals.find(
              (appraisal) =>
                Number(appraisal.creatorDepartmentId) !==
          ...
          console.log("Property appraisals:", appraisals);
          console.log("Main office appraisal:", mainOfficeForm);
          console.log("External appraisal:", externalForm);
            ...
            >
              ...
              >
                <div className="space-y-3">
                  {/* فرم شعبه / شعبه مستقل / منطقه: فقط مشاهده */}
                  {externalAppraisal && (
