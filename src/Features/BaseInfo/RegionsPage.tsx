...
export default function RegionsPage() {
    ...
    const [provinceCityDraft, setProvinceCityDraft] =
        useState<ProvinceCityDraft>(emptyProvinceCityDraft);
        ...
        <MainLayout.Main maxWidth="screen-xl">
            ...
            <Modal
                ...
                renderContent={() => (
                    <p>
                        آیا از حذف{" "}
                        <strong>{regionToDelete ? regionToDelete.title ?? "" : ""}</strong>{" "}
                        اطمینان دارید؟
                    </p>
                )}
            />
