...
export default function ExpertiseZonesPage() {
    ...
    const [zoneToDelete, setZoneToDelete] = useState<ExpertiseZoneItem | null>(null);
    ...
    const createMutation = useMutation({
        mutationFn: (body: CreateExpertiseZoneBody) =>
            createExpertiseZone(body),
